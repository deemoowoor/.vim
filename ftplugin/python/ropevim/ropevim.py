...
variables = {'ropevim_enable_autoimport': 1,
             ...
             'ropevim_local_prefix': '"<LocalLeader>r"',
             'ropevim_global_prefix': '"<LocalLeader>p"',
             'ropevim_vim_completion': 0,
             'ropevim_guess_project': 0}

shortcuts = {'code_assist': '<M-/>',
             'lucky_assist': '<M-?>',
             'goto_definition': '<LocalLeader>g',
             'show_doc': '<LocalLeader>d',
             'find_occurrences': '<LocalLeader>f'}
